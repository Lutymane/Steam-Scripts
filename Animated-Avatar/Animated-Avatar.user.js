...
const presetsData = [
    ...
    [1025050, 5, ["https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/7e/7ea490f5d317a556db7f49634708ed8aebdc4862_medium.jpg", "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/e7/e7882c764a22e957a326bcf578c66e142dbb289c_medium.jpg", "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/81/81361e671ea2e7c93cd81507cfdad2c539c981c9_medium.jpg", "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/5d/5d5eb973591f22633e6960ee69d0789ba3736aea_medium.jpg", "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/6d/6d26d6ea9335d3ecd7a6ca81a18381ff69defc30_medium.jpg",]],
];
/*
const presets = [
    [471220, 4],
    ...
    if (current < presets.length) {
        $J.get(`https://steamcommunity.com/games/${presets[current][0]}/Avatar/List`).done(data => {
            ...
            for (var i = 1; i < presets[current][1] * 3; i += 3) {
                preset_arr += '"' + imgs.eq(i).attr('src').substr(69) + '", ';
            }
