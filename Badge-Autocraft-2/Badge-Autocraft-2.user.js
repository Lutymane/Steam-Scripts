...
// @match        https://steamcommunity.com/*/*/badges/
// @match        https://steamcommunity.com/*/*/badges/?p=*
// @homepageURL  https://github.com/Lutymane/Steam-Scripts
// @supportURL   https://github.com/Lutymane/Steam-Scripts/issues
// @updateURL    https://github.com/Lutymane/Steam-Scripts/raw/master/Badge-Autocraft-2/Badge-Autocraft-2.meta.js
// @downloadURL  https://github.com/Lutymane/Steam-Scripts/raw/master/Badge-Autocraft-2/Badge-Autocraft-2.user.js
        ...
        if (window.localStorage.getItem('PageFlag') == '1') {
            ...
            if (NumberOfBadgesToCraftOnPage > window.localStorage.getItem('Skipped')) {
                ...
                if (window.localStorage.getItem('Skipped') == '150') {
                    ...
                    if (LevelsCrafted == 0) {
                        ShowAlertDialog('Info', '<span style=\"color: Red;\">No badges have been crafted! It seems, that you\'ve set up the script wrong. Please, check the settings</span>');
                        LevelsCrafted = 0;
                    }
                    else {
